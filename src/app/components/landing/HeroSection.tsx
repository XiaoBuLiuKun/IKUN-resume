...
const SimpleFloatingIcon = ({ icon: Icon, delay = 0 }: { 
  ...
  <motion.div
    ...
    className="absolute text-blue-400/20 hidden md:block"
  >
    <Icon size={20} />
  </motion.div>
);
    ...
    >
      ...
      <div className="flex flex-col items-center text-center max-w-5xl mx-auto relative z-10 gap-16">
        ...
        >
          ...
          {/* 副标题 */}
          <motion.p 
            className="text-xl md:text-2xl text-neutral-300 mb-8 max-w-2xl leading-relaxed"
        ...
        >
          ...
          {/* 主图片容器 */}
          <div className="relative bg-neutral-900/90 border border-neutral-700/50 rounded-2xl p-2 shadow-lg group hover:border-blue-400/50 hover:shadow-xl transition-all duration-300">
            {/* 图片 */}
            <div className="relative overflow-hidden rounded-xl">
              ...
              {/* 轻量级悬浮叠加 */}
              <div className="absolute inset-0 bg-gradient-to-t from-blue-900/0 to-blue-900/0 group-hover:from-blue-900/10 group-hover:to-transparent transition-all duration-300 rounded-xl" />
            </div>
          </div>

          {/* 简化的装饰元素 */}
          <div className="absolute -top-4 -right-4 w-8 h-8 bg-blue-400 rounded-full opacity-50 blur-xl" />
          <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-indigo-400 rounded-full opacity-50 blur-xl" />
        </motion.div>
      </div>
